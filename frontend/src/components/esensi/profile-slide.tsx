...
export const ProfileSlide = ({
    ...
    return(
        ...
        <div className={`hidden lg:flex flex-col fixed gap-4 py-6 px-8 top-0 right-0 bottom-0 w-[300px] h-full bg-white z-60 transition-transform duration-300 ${open ? "translate-x-0 shadow-[-4px_0_30px_1px_rgba(0,0,0,0.15)]" : "translate-x-full"}`}>
