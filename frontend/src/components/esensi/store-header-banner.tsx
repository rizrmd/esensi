...
export const StoreHeaderBanner = ({
  ...
  return (
    <div className="w-full h-auto relative">
      <Link href={btnurl} className="w-full h-auto aspect-video flex flex-col lg:hidden" target={btnnewtab ? "_blank" : "_self"}>
        <ImgThumb src={bannerImage} skipResize={true} className="absolute top-0 left-0 w-full h-full object-cover object-center" />
