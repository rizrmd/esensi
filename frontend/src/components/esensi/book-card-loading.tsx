export const BookCardLoading = () => {
  return (
    <div className="esensi-book-loading flex flex-col justify-center items-center gap-3 py-4 px-2 lg:px-4 relative cursor-pointer box-border w-full animate-pulse duration-900">
