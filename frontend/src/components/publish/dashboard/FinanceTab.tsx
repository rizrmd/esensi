...
export const FinanceTab = ({ data }: FinanceTabProps) => {
  ...
  const handleWithdrawal = async (e: FormEvent) => {
    ...
    if (!local.withdrawBank || !local.withdrawAccount || !local.withdrawAccountName) {
      local.error = "Mohon isi semua kolom";
      local.render();
      return;
    }
    
    if (amount > (transactions?.balance || 0)) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Dialog open={local.isWithdrawDialogOpen} onOpenChange={(open) => {
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Masukkan jumlah dan tujuan penarikan dana. 
                Proses penarikan dana membutuhkan waktu 1-3 hari kerja.
              </DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleWithdrawal} className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Saldo tersedia: {formatCurrency(transactions?.balance || 0)}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e => {
                    local.withdrawAccount = e.target.value.replace(/[^\d]/g, "");
                    local.render();
                  }}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Saldo tersedia untuk penarikan dana
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-3xl font-bold">
            {formatCurrency(transactions?.balance || 0)}
          </div>
      ...
      <Tabs value={local.activeTab} onValueChange={(value) => {
        ...
        <TabsContent value="withdrawals" className="space-y-4">
          {transactions?.withdrawals && transactions.withdrawals.length > 0 ? (
            <div className="border rounded-lg overflow-hidden">
              <Table>
                <TableHeader>
                  <TableRow>
