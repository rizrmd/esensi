  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success && res.data) {
        ...
        local.error = "Gagal memperbarui affiliate.";
      }
    } catch (error: any) {
      local.error = error.message || "Terjadi kesalahan saat memperbarui affiliate.";
    } finally {
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="flex gap-4 pt-6">
                        <Button
                          type="button"
                          variant="outline"
                          onClick={() => navigate(`/affiliate-stats?id=${local.affiliate?.id}`)}
                          disabled={local.submitting}
                        >
              ...
              <div className="space-y-6">
                ...
                <Card className="shadow-sm border border-gray-200">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm text-gray-500">Pengguna Terhubung</p>
                        <p className="font-semibold">{local.affiliate.auth_user?.length || 0}</p>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    {local.stats.loading ? (
                      <div className="text-center py-4">
                        ...
                        <p className="text-sm text-gray-500 mt-2">Memuat statistik...</p>
                      </div>
                    ) : local.stats.data ? (
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-2xl font-bold text-green-600">
                            Rp {(local.stats.data.totalCommission || 0).toLocaleString('id-ID')}
                          </p>
                        </div>
                      </div>
                    ) : (
                ...
                {/* Connected Users */}
                {local.affiliate.auth_user && local.affiliate.auth_user.length > 0 && (
                  <Card className="shadow-sm border border-gray-200">
                    <CardHeader>
                      <CardTitle className="text-lg">Pengguna Terhubung</CardTitle>
                    </CardHeader>
                    <CardContent>
