                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-green-600">
                          Rp{" "}
                          {(local.stats.totalCommission || 0).toLocaleString(
                            "id-ID"
                          )}
                        </p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-orange-600">
                          {local.stats.conversionRate
                            ? `${local.stats.conversionRate.toFixed(1)}%`
                            : "0%"}
                        </p>
                      </div>
                  ...
                  <CardContent>
                    {local.stats.monthlyPerformance ? (
                      <div className="space-y-4">
                        {local.stats.monthlyPerformance.map(
                            ...
                            >
                              ...
                              <div className="text-right">
                                <p className="font-semibold text-green-600">
                                  Rp{" "}
                                  {product.commission.toLocaleString("id-ID")}
                                </p>
                              </div>
                            </div>
                          )
              ...
              <Card className="shadow-sm border border-gray-200">
                ...
                <CardContent>
                  {local.stats.recentActivities ? (
                    <div className="space-y-4">
                      {local.stats.recentActivities.map(
                        (activity: any, index: number) => (
                          <div
                            key={index}
                            className="flex justify-between items-center p-4 border-l-4 border-blue-500 bg-blue-50"
                          >
                            <div>
