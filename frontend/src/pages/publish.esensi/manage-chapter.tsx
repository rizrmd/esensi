...
export default () => {
  ...
  async function loadData() {
    ...
    try {
      ...
      const res2 = await api.chapter_list({
        page: local.page,
        limit: local.limit,
        id_book: local.bookId,
      });
      local.chapters = res2.data || [];
      local.total = res2.pagination!.total || 0;
      local.page = res2.pagination!.page || 0;
      local.limit = res2.pagination!.limit || 0;
      local.totalPages = res2.pagination!.totalPages || 0;
    } catch (error) {
