...
import type { BadgeStatus } from "backend/lib/types";
import {
  BarChart3,
  Book,
  Calendar,
...
export default () => {
  ...
  const loadDashboardStats = async () => {
    try {
      ...
      if (result && result.data) local.stats = result.data as DashboardStats;
    } catch (error: any) {
            ...
            <div className="space-y-8">
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {local.stats.overview.total_books.toLocaleString("id-ID")}
                    </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">
                      {formatCurrency(local.stats.overview.total_sales_revenue)}
                    </div>
                    <p className="text-xs text-muted-foreground">
                      Total penjualan
                    </p>
