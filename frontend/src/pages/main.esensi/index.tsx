  ...
  return (
    <div className="flex flex-1 flex-col justify-center items-center">
      <div className="flex flex-1 flex-wrap flex-col justify-center items-center max-w-[1000px]">
        <img
          src="https://esensi.online/_img/upload/2025-2/6/1741225915292-ramadhan%202025%20-%20website_artboard%206%20copy%202.jpg?w=1000"
          alt=""
        />
        <img src="https://esensi.online/_img/upload/2025-2/6/1741225933693-ramadhan 2025 - website_artboard 7 copy 2.jpg?w=1000" />
        <p className="absolute w-0 h-0 top-0 left-0 overflow-hidden">
          Home Website Esensi.Online | PT Meraih Ilmu Semesta | Penerbit Esensi
          Semesta | Ebook berkualitas, harga hemat dan mudah akses | diskon
          berbagai ebook
        </p>
        <a href="/store">
          <img src="https://esensi.online/_img/upload/2025-2/6/1741225963510-ramadhan 2025 - website_artboard 9 copy 2.jpg?w=1000" />
          <p className="absolute w-0 h-0 top-0 left-0 overflow-hidden">
            Belanja Sekarang Ebook Esensi Semesta
          </p>
        </a>
        <a href="/store">
