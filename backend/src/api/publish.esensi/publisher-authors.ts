  ...
  async handler(arg: { 
    ...
    try {
      ...
      if (arg.action === 'list') {
        ...
        if (existingRelation) {
          return { success: false, message: "Penulis sudah tergabung dengan penerbit ini" };
        }
        ...
        return { success: true, message: "Penulis berhasil dihapus dari penerbit" };
      }
      else {
      ...
      return { success: false, message: "Terjadi kesalahan dalam mengelola penulis" };
    }
  },
});